class Priority < ActiveRecord::Base
  ...
  scope :top_24hr, :conditions => "priorities.position_endorsed_24hr IS NOT NULL", :order => "priorities.position_endorsed_24hr desc"
  scope :top_7days, :conditions => "priorities.position_endorsed_7days IS NOT NULL", :order => "priorities.position_endorsed_7days desc"
  scope :top_30days, :conditions => "priorities.position_endorsed_30days IS NOT NULL", :order => "priorities.position_endorsed_30days desc"
