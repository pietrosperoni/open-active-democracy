...
class MasterProcessing < VideoProcessing
  ...
  def self.download_master_video(master_video)
    master_video_path = "#{Rails.root.to_s}/private/"+ENV['RAILS_ENV']+"/process_speech_master_videos/#{master_video.id}/"
  ...
  def self.convert_master_to_flash(master_video)
    master_video_filename = "#{Rails.root.to_s}/private/"+ENV['RAILS_ENV']+"/process_speech_master_videos/#{master_video.id}/master.wmv"
    master_video_flv_tmp_filename = "#{Rails.root.to_s}/private/"+ENV['RAILS_ENV']+"/process_speech_master_videos/#{master_video.id}/master.tmp.flv"
