...
Category.create(:name=>"Trasporti")
Category.create(:name=>"Lavoro")
Category.create(:name=>"Risparmio")
Category.create(:name=>"Partecipazione democratica")
Category.create(:name=>"Legalità, Sicurezza")
Category.create(:name=>"Reti Sociali")
Category.create(:name=>"Salute")
Category.create(:name=>"Territorio, Urbanistica")
Category.create(:name=>"Patrimonio")
Category.create(:name=>"Sociale, Famiglia, Persona")
Category.create(:name=>"Istruzione, Giovani, Infanzia")
Category.create(:name=>"Sport, Tempo libero")
Category.create(:name=>"Sviluppo")
Category.create(:name=>"Ambiente")
Category.create(:name=>"Arte, Cultura, Spettacolo, Turismo")
Category.create(:name=>"Infrastrutture")
Category.create(:name=>"Rappresentanti, Nomine")
Category.create(:name=>"Aziende Partecipate")
